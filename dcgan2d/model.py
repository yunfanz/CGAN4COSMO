        ...
        for epoch in xrange(config.epoch):
            ...
            for idx in xrange(0, batch_idxs):
                ...
                if False:
                    ...
                    errD_real = self.d_loss_real.eval({self.y:batch_labels, self.inputs: batch_images})
                    ...
                    D_real = self.D.eval({self.y:batch_labels, self.inputs: batch_images}).mean()
                    D_fake = self.D_.eval({self.z: batch_z, self.y:batch_labels}).mean()
